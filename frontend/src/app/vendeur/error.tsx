/**
 * Route UI: app/vendeur/error
 *
 * Rôle du fichier :
 *   Error Boundary du dashboard vendeur. Affiché si `page.tsx` lève une
 *   exception inattendue (les échecs réseau « normaux » sont gérés en
 *   douceur dans les helpers qui renvoient null/[]).
 *
 * Prérequis :
...
export default function VendeurError({ error, reset }: Props) {
  useEffect(() => {
    console.error("Erreur de l'espace vendeur :", error);
  }, [error]);
    ...
    <section className="container py-5">
      <div className="text-center mx-auto" style={{ maxWidth: "520px" }}>
        ...
        <h1 className="h3 fw-bold mt-3">
          Impossible d&apos;afficher l&apos;espace vendeur
        </h1>
